...
public class PageManager {
	...
	public static File expectedImageFile;
	protected WebDriver driver;
	protected String browserFlag;
	protected ExtentTest test;
	protected Log log = LogFactory.getLog(this.getClass());
	protected String env;
	String currentPath1 = ".\\test-output\\errorImages";

	public PageManager(EventFiringWebDriver driver2, String browser, String environment, ExtentTest extentTest) {
	 ...
	 */
	public void waitAndSendkeys(WebElement element, String keys, int numberOfSeconds) {
		try {
	...
	/**
	 * This Method returns the tag name of the tagName of the webElement
	 * 
	 * @param element
	 * @return
	 */
	public String getTagName(WebElement element) {
		String tagNameValue = null;
		try {
			tagNameValue = element.getTagName();
			test.log(Status.INFO, "Get Tag Name " + tagNameValue + " of " + element.toString());
		} catch (Exception exception) {
			exceptionPrintError(exception, element);
		}
		return tagNameValue;
	 ...
	 * @return
	 */
	public String getHrefValue(WebElement element) {
		String textValue = null;
		try {
			textValue = element.getAttribute("href");
			test.log(Status.INFO, "Get value " + textValue + " of " + element.toString());
		} catch (Exception exception) {
			exceptionPrintError(exception, element);
		}
		return textValue;
	 ...
	 * @param locator
	 */
	public void hoverElement(final By locator) throws InterruptedException {
		Actions action = new Actions(driver);
	...
	public boolean isElementVisible(final By locator) {
		...
		try {
			WebElement Element = (new WebDriverWait(driver, Duration.ofSeconds(60), Duration.ofMillis(5000))).until(new ExpectedCondition<WebElement>() {
			...
			test.error(this.getClass().getName() + e.getMessage());
		}
		return false;
	}
	...
	public void clickByJavaScriptExecutor(final By locator) {
		try {
			...
			test.error("Method[clickByJavaScriptExecutor] cannot find this element " + exception.getMessage());
		}
	}
	...
	public void addCookie(String name, String value) {
		try {
			...
			exceptionPrintError(exception, null);
			test.log(Status.ERROR, name + "Cookie have not been added");
		}
	}
...
/*public void logToReport(String element){
		
		test.log(Status.PASS, "" + element);*/
	
	public void logToReport(String element){
		test.log(Status.PASS,MarkupHelper.createLabel(element,ExtentColor.BLUE));
	}
	
	public void logToReportImageComparison(String element){
		test.log(Status.PASS,MarkupHelper.createLabel(element,ExtentColor.AMBER));
	}
/*
	* This method logs the test status as Pass followed by the passing point(s)
	*/
	public void testpass(String passPoint) throws Exception
	{
	test.log(Status.PASS,MarkupHelper.createLabel(passPoint, ExtentColor.GREEN));
	}

	/*
	* This method logs the test status as Info followed by the information point(s)
	*/
	public void testInfo(String infoPoint) throws Exception
	{
	test.log(Status.INFO, infoPoint);
	}

	/*
	* This method logs the test status as Fail followed by the failing point(s)
	*/
	public void testfail(String failPoint) throws Exception
	{
		...
		try {
			if(path.contains("@@@"))
			{
				...
				test.log(Status.FAIL,MarkupHelper.createLabel(failPoint+ "\nScreencast below: "+ test.addScreenCaptureFromPath(arrOfStr[0])+" "+test.addScreenCaptureFromPath(arrOfStr[1]), ExtentColor.RED) );
				//test.log(Status.FAIL, failPoint+ "\nScreencast below: "+ test.addScreenCaptureFromPath(arrOfStr[1]));
			}else
			{
				test.log(Status.FAIL, failPoint+ "\nScreencast below: "+ test.addScreenCaptureFromPath(path));
			}
	...
	* This method logs the test status as Fail followed by the failing point(s)
	*/
	public void testfailAPI(String failPoint) throws Exception
	{
	test.log(Status.FAIL, failPoint);
	}
	...
	public String snapshot() {
		...
		if (test)
		{
			...
			File scrFile = drivername.getScreenshotAs(OutputType.FILE);
				...
				log.info("save snapshot path is:" + currentPath + separator + name + ".png");
	...
	/**
	 * Verify existence of the element.
	 * @param locator
	 */
	public boolean verifyElementExists(final By locator) {
		try {
			List<WebElement> elementList = (new WebDriverWait(driver, Duration.ofSeconds(60), Duration.ofSeconds(5)))
					.until(new ExpectedCondition<List<WebElement>>() {
						public List<WebElement> apply(WebDriver d) {
							test.info("method[verifyElementExists] try to find element in HTML "
									+ locator);
							return d.findElements(locator);
						}
					});
			if (elementList.size() > 0){return true;}
	...
	/**
	 * Find all the elements and return a list.
	 * @param locator
	 */
	public List<WebElement> getList(final By locator){
	 ...
	 * @param locator
	 */
	public void waitElementVisible(final By locator) {
		waitForPageLoaded();
			...
			(new WebDriverWait(driver, Duration.ofSeconds(60), Duration.ofSeconds(5)))
					.until(new ExpectedCondition<Boolean>() {
						public Boolean apply(WebDriver d) {
							test.info("method[waitElementVisible]try to find element "
									+ locator + " to visible");
							WebElement element = d.findElement(locator);
							if (element.isEnabled()) {
								test.info("Element" + locator + " is found");
								return true;
							}
	 ...
	 * @param locator
	 */
	public void waitElementEnabled(final By locator) {
		waitForPageLoaded();
		try {//WebElement element = driver.findElement(locator);
			(new WebDriverWait(driver, Duration.ofSeconds(60), Duration.ofMillis(5000)))
					.until(new ExpectedCondition<Boolean>() {
						public Boolean apply(WebDriver d) {
							test.info("method[waitElementVisible]try to find element "
									+ locator + " to visible");
							WebElement element = d.findElement(locator);
							if (element.isEnabled()) {
								test.info("Element" + locator + " is enabled");
								return true;
							}
							return element.isEnabled();
						}
	 ...
	 * @throws IOException
	 */
	public void findBrokenLinks(String url) throws ClientProtocolException, IOException {
//		System.setProperty("javax.net.ssl.trustStore","clientTrustStore.key");
		...
		for (WebElement webElement : allLinks) {
			...
			allLinks = getDriver().findElements(By.tagName("a"));
			try {
				String href = webElement.getAttribute("href");
	            if (href.equals("#"))
	                continue;
				...
				if (responseCode != 200) {
					test.log(Status.FAIL, " Link " + link + " is Broken with response code "+responseCode);
				}
				else
				{
					test.log(Status.PASS, " Link " + link + " has response code "+responseCode);
				}
			} catch (Exception exception) {
				exceptionPrintError(exception,allLinks.get(counter));
				exceptionPrintError(exception, null);
	 ...
	 * @throws IOException
	 */
	public void getUrlStatusCode(String url) throws ClientProtocolException, IOException {
//		System.setProperty("javax.net.ssl.trustStore","clientTrustStore.key");
				int responseCode = Request.Get(url).execute().returnResponse().getStatusLine().getStatusCode();
				
				if (responseCode != 200) {
					test.log(Status.FAIL, " Link " + url + " is Broken with response code "+responseCode);
				}
				else
				{
					test.log(Status.PASS, " Link " + url + " has response code "+responseCode);
				}
	...
	public boolean verifyElementClickable(final By locator) {
        try {

            (new WebDriverWait(driver, Duration.ofSeconds(30) ,Duration.ofMillis(5000) ))
                    .until(new ExpectedCondition<Boolean>() {
                        public Boolean apply(WebDriver d) {
                            log.info("method[isElementClickable]try to find element "
                                    + locator);
                            WebElement element = d.findElement(locator);
                            if (element.isDisplayed()) log.info("Element" + locator + "is found");
                            return element.isDisplayed();
                        }
                    });
        } catch (Exception e) {
	...
	/**
	 * @author - Zainab Firdos
	 * @description - This method will take the screenshot of current component
	 */
	public void getScreenShotOfSpecificComponent(final By locator) throws IOException {
		WebElement comp= driver.findElement(locator);
		File scrfile=comp.getScreenshotAs(OutputType.FILE);
		String dt = getDatetime();
		System.out.println("save snapshot path is:" + currentPath1 + "\\" +"SS_" +dt + ".png");
		FileUtils.copyFile(scrfile, new File(currentPath1 + "\\" + "SS_"+dt + ".png"));
		}
	
	/**
	 * This Method checks if WebElement is displayed
	 *
	 * @return strUrl
	 */
	...
	public void printMessageInConsole(String data)
	{
	 ...
	 * @return
	 */
	public String getAttribute_value(WebElement element) 
	{
		String t = null;
		try {
			t = element.getAttribute("value");
			test.log(Status.PASS, "Get Attribute " + t + " of " + element.toString());
		} catch (Exception exception) {
			exceptionPrintError(exception,element);
		} 
		return t;
	...
	public void pageRefresh(){
		try{
			...
			test.error("Method of [pageRefresh] in " + this.getClass().getName() + ex.getMessage());
		}
	}
	...
	public void waitForLoad() {
		new WebDriverWait(driver, Duration.ofSeconds(60)).until(new ExpectedCondition<Boolean>() {
			...
			public Boolean apply(WebDriver wb) {
				try {
					return ((Long) ((JavascriptExecutor) wb).executeScript("return jQuery.active") == 0);
				} catch (Exception ex) {
					return true;
				}
			}
	...
	/**
	 * This Method returns the current URL of the web page
	 *
	 * @return strUrl
	 */
	...
	public boolean verifyElementEnabled(WebElement element) {
		try {
			element.isEnabled();
			test.log(Status.PASS, element.toString() + " is enabled.");
		} catch (Exception exception) {
			exceptionPrintError(exception,element);
	...
	public void clickOnWebelemntBy_XY_Coordinates(int X, int Y) throws InterruptedException {
		try {
			Actions actions = new Actions(driver);

			actions.moveByOffset(X, Y).click().build().perform();
			System.out.println("Clicked on X and Y cordinate on the web page");
	...
	public boolean isElementVisible1(final By locator) {
		waitForPageLoaded();//WebElement element = driver.findElement(locator);
		try {
			WebElement Element = new WebDriverWait(driver, Duration.ofSeconds(60))
					.until(new ExpectedCondition<WebElement>() {
						public WebElement apply(WebDriver d) {
							test.info("method[isElementVisible] try to find element in HTML "
									+ locator);
							return d.findElement(locator);
						}
					});
	...
	public String saveSubScreenShot (PageManager pageManager, WebElement elementInterestedIn, int upperX, int upperY, int width, int height)
			 throws Exception
			{

				String s = elementInterestedIn.getCssValue("color");
				String c = Color.fromString(s).asHex();

				TakesScreenshot scrShot = ((TakesScreenshot) elementInterestedIn);
				Dimension dim = elementInterestedIn.getSize();
				org.openqa.selenium.Rectangle rect = elementInterestedIn.getRect();
				String[] temp = elementInterestedIn.toString().split("xpath:");
				String eleXpath = temp[temp.length-1];
				File scrShotFile = scrShot.getScreenshotAs(OutputType.FILE);
				BufferedImage img = ImageIO.read(scrShotFile);
				int h = img.getHeight();
				int w = img.getWidth();
				BufferedImage dest = null;
				pageManager.logToReport("Starting to capture image.");
				try {
					dest = img.getSubimage(upperX, upperY, width, height);
				}
				catch (Exception e) {
					String text  = "Could not take a picture of the area with provided values of: upperX: " + upperY + ", upperY: " + upperY + ", width: " + width + ", and height: " + height + ".  ";
					text = text + "So going to take picture of entire area where the values are: upperX: 0, upperY: 0, width: " + w + ", and height: " + h + ".";
					pageManager.testWarning(text);
					dest = img.getSubimage(0, 0, w, h);
				}

				ImageIO.write(dest, "png", scrShotFile);
				String dateTime = pageManager.getDatetime();
				String fileName = dateTime + ".png";
				String path = System.getProperty("user.dir");
				String destScreenShotPathName = "";
				if (path.startsWith("/")) {
					destScreenShotPathName = path + "/errorImages/" + fileName;
				}
				else {
					destScreenShotPathName = path + "\\errorImages\\" + fileName;
				}
				File DestFile = new File(destScreenShotPathName);
				FileUtils.copyFile(scrShotFile, DestFile);
				pageManager.logToReport("Finished capturing image.");
				Thread.sleep(1000);
				return destScreenShotPathName;
			}
	
	/*
	 * This method logs the test status as Warning followed by the warning point(s)
	 */
	public void testWarning (String warnPoint) throws Exception {
		test.log(Status.WARNING, MarkupHelper.createLabel(warnPoint, ExtentColor.YELLOW));
	}

	/*
	 * This method logs the test status as Warning followed by the warning point(s) and includes expected and actual images
	 */
	public void testWarningWithImages(String warnPoint, String expectedImage, String actualImage) throws Exception
	{
		test.log(Status.WARNING,MarkupHelper.createLabel(warnPoint+ "\nExpected and Actual Images are below: "+ test.addScreenCaptureFromPath(expectedImage)+" "+test.addScreenCaptureFromPath(actualImage), ExtentColor.ORANGE) );
	}

	/*
	 * This method logs the test status as Warning followed by the warning point(s) and includes an image
	 */
	public void testWarningWithImage(String warnPoint, String actualImage) throws Exception
	{
		test.log(Status.WARNING,MarkupHelper.createLabel(warnPoint+ "\nActual Image is below: " + test.addScreenCaptureFromPath(actualImage), ExtentColor.ORANGE) );
	}
	...
	/*
	 * This method is use to capture the screenshot of the specific webElement
	*/
	public void captureScrrenshotOfSpecificWebElement(WebElement element, String store) {
		try {
			...
			executor.executeScript("arguments[0].scrollIntoView();", element);
			 ...
			 if(store.equals("boost"))
			 {
				 FileHandler.copy(actualImage, new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//PaymentCards//capturedExpectedImage//paymentCardsImage.png"));
				 file = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//PaymentCards//capturedExpectedImage//paymentCardsImage.png");
			 }
			 else if(store.equals("beacon"))
			 {
				  FileHandler.copy(actualImage, new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Beacon//PaymentCards//capturedExpectedImage//paymentCardsImage.png"));
				  file = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Beacon//PaymentCards//capturedExpectedImage//paymentCardsImage.png");
			
			 }
			 else if(store.equals("genesis"))
			 {
				  FileHandler.copy(actualImage, new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Genesis//PaymentCards//capturedExpectedImage//paymentCardsImage.png"));
				  file = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Genesis//PaymentCards//capturedExpectedImage//paymentCardsImage.png");  
			 }
			 
			 if(file.exists())
			 {
				 test.log(Status.PASS, "paymentCardPage screenshot has been captured");
			 }
			 else
			 {
				 test.log(Status.FAIL, "paymentCardPage screenshot has not been captured");
			 }
	...
	*/
	public void screenshotComparison(WebElement element, String store) {
		try {
		    ...
		    if(store.equals("boost"))
			 {
		    	FileUtils.copyFile(actualFile, new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//PaymentCards//capturedActualImage//paymentCardsImage.png"));
			     actualImageFile = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//PaymentCards//capturedActualImage//paymentCardsImage.png");
			    
			     expectedImageFile = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//PaymentCards//capturedExpectedImage//paymentCardsImage.png");		   
			 }
			 else if(store.equals("beacon"))
			 {
				 	FileUtils.copyFile(actualFile, new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Beacon//PaymentCards//capturedActualImage//paymentCardsImage.png"));
				 	actualImageFile = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Beacon//PaymentCards//capturedActualImage//paymentCardsImage.png");
				    
				 	expectedImageFile = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Beacon//PaymentCards//capturedExpectedImage//paymentCardsImage.png");	    
			 }
			 else if(store.equals("genesis"))
			 {
				 	FileUtils.copyFile(actualFile, new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Genesis//PaymentCards//capturedActualImage//paymentCardsImage.png"));
				 	actualImageFile = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Genesis//PaymentCards//capturedActualImage//paymentCardsImage.png");
				    
				 	expectedImageFile = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Genesis//PaymentCards//capturedExpectedImage//paymentCardsImage.png");
			 }
			...
			{
				test.log(Status.FAIL, "actual and expected image are not same");
			}
			else
			{
	...
	public void captureScrrenshotOfEntirePage(String store) throws Exception 
	{
			 File actualFile = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
			 BufferedImage  actualImage = ImageIO.read(actualFile);
			 
			 if(store.equals("boostPermalinkFormPage"))
			 {
				 FileHandler.copy(actualFile, new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//PermalinkFormPage//capturedExpectedImage//permalinkForm.png"));
				 file = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//PermalinkFormPage//capturedExpectedImage//permalinkForm.png");
			 }
			 else if(store.equals("boostPingLoginPage"))
			 {
				 FileHandler.copy(actualFile, new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//PingLoginPage//capturedExpectedImage//pingLogin.png"));
				 file = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//PingLoginPage//capturedExpectedImage//pingLogin.png");
			 }
			 else if(store.equals("boostBuyFlowPage"))
			 {
				 FileHandler.copy(actualFile, new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//BuyFlowPage//capturedExpectedImage//buyFlow.png"));
				 file = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//BuyFlowPage//capturedExpectedImage//buyFlow.png");
			 }
			 else if(store.equals("ICCIDActivationPage"))
			 {
				 FileHandler.copy(actualFile, new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//ICCIDActivationPage//capturedExpectedImage//iccidActivation.png"));
				 file = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//ICCIDActivationPage//capturedExpectedImage//iccidActivation.png");
			 }
			 else if(store.equals("IMEIActivationPage"))
			 {
				 FileHandler.copy(actualFile, new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//IMEIActivationPage//capturedExpectedImage//iccidActivation.png"));
				 file = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//IMEIActivationPage//capturedExpectedImage//iccidActivation.png");
			 }
			 else if(store.equals("NRBlankSIMActivationTypePage"))
			 {
				 FileHandler.copy(actualFile, new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//NRBlankSIMActivationTypePage//capturedExpectedImage//nrBlankSIMActivationType.png"));
				 file = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//NRBlankSIMActivationTypePage//capturedExpectedImage//nrBlankSIMActivationType.png");
			 }
			 else if(store.equals("ExistingPhoneNumberPage"))
			 {
				 FileHandler.copy(actualFile, new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//NRBlankSIMExistingPhoneNumberPage//capturedExpectedImage//NRBlankSIMExistingPhoneNumber.png"));
				 file = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//NRBlankSIMExistingPhoneNumberPage//capturedExpectedImage//NRBlankSIMExistingPhoneNumber.png");
			 }
			 else if(store.equals("SubsriberHomePage"))
			 {
				 FileHandler.copy(actualFile, new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//BoostSubsriberSignUpPage//capturedExpectedImage//boostSubsriberSignUpPage.png"));
				 file = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//BoostSubsriberSignUpPage//capturedExpectedImage//boostSubsriberSignUpPage.png");
			 }
			 else if(store.equals("CustomerSignUpPage"))
			 {
				 FileHandler.copy(actualFile, new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//BoostSubsriberCustomerSignUpPage//capturedExpectedImage//boostSubsriberCutomerSignUpPage.png"));
				 file = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//BoostSubsriberCustomerSignUpPage//capturedExpectedImage//boostSubsriberCutomerSignUpPage.png");
			 }
			 else if(store.equals("AppleNPIHomePage"))
			 {
				 FileHandler.copy(actualFile, new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//BoostAppleNPIHomePage//capturedExpectedImage//boostAppleNPIHomePage.png"));
				 file = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//BoostAppleNPIHomePage//capturedExpectedImage//boostAppleNPIHomePage.png");
			 }
	...
	public void entirePageScreenshotComparison(String store) throws Exception {
		    ...
		    if(store.equals("boostPermalinkFormPage"))
			 {
		    	 FileUtils.copyFile(actualFile, new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//PermalinkFormPage//capturedActualImage//permalinkForm.png"));
			     actualImageFile = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//PermalinkFormPage//capturedActualImage//permalinkForm.png");
			    
			     expectedImageFile = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//PermalinkFormPage//capturedExpectedImage//permalinkForm.png");		   
			 }
		    else if(store.equals("boostPingLoginPage"))
			 {
		    	 FileUtils.copyFile(actualFile, new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//PingLoginPage//capturedActualImage//pingLogin.png"));
			     actualImageFile = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//PingLoginPage//capturedActualImage//pingLogin.png");
			    
			     expectedImageFile = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//PingLoginPage//capturedExpectedImage//pingLogin.png");		   
			 }
		    else if(store.equals("boostBuyFlowPage"))
			 {
		    	 FileUtils.copyFile(actualFile, new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//BuyFlowPage//capturedActualImage//buyFlow.png"));
			     actualImageFile = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//BuyFlowPage//capturedActualImage//buyFlow.png");
			    
			     expectedImageFile = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//BuyFlowPage//capturedExpectedImage//buyFlow.png");		   
			 }
		    else if(store.equals("ICCIDActivationPage"))
			 {
		    	 FileUtils.copyFile(actualFile, new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//ICCIDActivationPage//capturedActualImage//iccidActivation.png"));
			     actualImageFile = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//ICCIDActivationPage//capturedActualImage//iccidActivation.png");
			    
			     expectedImageFile = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//ICCIDActivationPage//capturedExpectedImage//iccidActivation.png");		   
			 }
		    else if(store.equals("IMEIActivationPage"))
			 {
		    	 FileUtils.copyFile(actualFile, new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//IMEIActivationPage//capturedActualImage//iccidActivation.png"));
			     actualImageFile = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//IMEIActivationPage//capturedActualImage//iccidActivation.png");
			    
			     expectedImageFile = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//IMEIActivationPage//capturedExpectedImage//iccidActivation.png");		   
			 }
		    else if(store.equals("NRBlankSIMActivationTypePage"))
			 {
		    	 FileUtils.copyFile(actualFile, new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//NRBlankSIMActivationTypePage//capturedActualImage//nrBlankSIMActivationType.png"));
			     actualImageFile = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//NRBlankSIMActivationTypePage//capturedActualImage//nrBlankSIMActivationType.png");
			    
			     expectedImageFile = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//NRBlankSIMActivationTypePage//capturedExpectedImage//nrBlankSIMActivationType.png");		   
			 }
		    else if(store.equals("ExistingPhoneNumberPage"))
			 {
		    	 FileUtils.copyFile(actualFile, new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//NRBlankSIMExistingPhoneNumberPage//capturedActualImage//NRBlankSIMExistingPhoneNumber.png"));
			     actualImageFile = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//NRBlankSIMExistingPhoneNumberPage//capturedActualImage//NRBlankSIMExistingPhoneNumber.png");
			    
			     expectedImageFile = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//NRBlankSIMExistingPhoneNumberPage//capturedExpectedImage//NRBlankSIMExistingPhoneNumber.png");		   
			 }
		    else if(store.equals("SubsriberHomePage"))
			 {
		    	 FileUtils.copyFile(actualFile, new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//BoostSubsriberSignUpPage//capturedActualImage//boostSubsriberSignUpPage.png"));
			     actualImageFile = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//BoostSubsriberSignUpPage//capturedActualImage//boostSubsriberSignUpPage.png");
			    
			     expectedImageFile = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//BoostSubsriberSignUpPage//capturedExpectedImage//boostSubsriberSignUpPage.png");		   
			 }
		    else if(store.equals("CustomerSignUpPage"))
			 {
		    	 FileUtils.copyFile(actualFile, new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//BoostSubsriberCustomerSignUpPage//capturedActualImage//boostSubsriberCutomerSignUpPage.png"));
			     actualImageFile = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//BoostSubsriberCustomerSignUpPage//capturedActualImage//boostSubsriberCutomerSignUpPage.png");
			    
			     expectedImageFile = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//BoostSubsriberCustomerSignUpPage//capturedExpectedImage//boostSubsriberCutomerSignUpPage.png");		   
			 }
		    else if(store.equals("AppleNPIHomePage"))
			 {
		    	 FileUtils.copyFile(actualFile, new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//BoostAppleNPIHomePage//capturedActualImage//boostAppleNPIHomePage.png"));
			     actualImageFile = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//BoostAppleNPIHomePage//capturedActualImage//boostAppleNPIHomePage.png");
			    
			     expectedImageFile = new File(System.getProperty("user.dir")+"//testdata//ImageComparison//Boost//BoostAppleNPIHomePage//capturedExpectedImage//boostAppleNPIHomePage.png");		   
			 }
