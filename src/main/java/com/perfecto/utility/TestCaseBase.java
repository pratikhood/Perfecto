...
public class TestCaseBase {
	...
	//RemoteWebDriver driver;
		...
		String cloudName = "dish-public";

		//Replace <<security token>> with your perfecto security token or pass it as maven properties: -DsecurityToken=<<SECURITY TOKEN>>  More info: https://developers.perfectomobile.com/display/PD/Generate+security+tokens
		String token = "eyJhbGciOiJIUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICI5OGQzMWI0OC1mODUyLTQ4ZTItOTgwMy03MmRhM2UyZDc3N2EifQ..03fmG6bwpJJmKmQauSrFW4G_ardgWHL7HkR81hzvGHA";
...
//		}
	...
	@Parameters({ "browserUsed", "runningOnGrid", "hubHost", "hubPort", "environment", "elasticIp",
		"elasticPort", "elasticIndex", "elasticContentType", "projectCode","suiteReportName"})
	...
	public void setUpBrowser( @Optional("chromeDesktop") String browserUsed, @Optional("false") String runningOnGrid,
			...
			@Optional("testing") String projectCode, @Optional("AutomationExecution") String suiteReportName) throws Exception {
		...
		initParams(browserUsed, runningOnGrid, hubHost, hubPort, environment, elasticIp, elasticPort,
				elasticIndex, elasticContentType, projectCode,suiteReportName);
...
//			driver.manage().window().maximize();
	...
	private void initParams(String browserUsed, String runningOnGrid, String hubHost, String hubPort, String env, String elasticIp, String elasticPort, String elasticIndex,
			String elasticContentType, String projectCode,String sampleSuitename) {
...
//	}
	...
	private void setUpChromeWin32Desktop(String onGrid) throws Exception {
		...
		Map<String,Object> perfectOptions = new HashMap<>();
		
		options.setPlatformName("Windows");
		perfectOptions.put("platformVersion", "11");
		perfectOptions.put("browserName", "Chrome");
		options.setBrowserVersion("119");
		perfectOptions.put("location", "US East");
		perfectOptions.put("resolution", "1024x768");
		perfectOptions.put("scriptName", "Windows-Chrome-Webtest-S4");
		options.setCapability("perfecto:options", perfectOptions);
		perfectOptions.put("securityToken", token);
		options.addArguments("user-agent=test-automation-96cbdf45-2232-48cd-be0c-ceb7942126b0");
        //options.addArguments("--headless");
        
		options.setAcceptInsecureCerts(true);
		//driver_original = new ChromeDriver(options);
		driver_original = new RemoteWebDriver(new URL("https://" + PerfectoLabUtils.fetchCloudName(cloudName) + ".perfectomobile.com/nexperience/perfectomobile/wd/hub"), options);
		reportiumClient = PerfectoLabUtils.setReportiumClient(driver_original, reportiumClient); //Creates reportiumClient
